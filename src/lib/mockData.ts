...
export const liveAlerts: LiveAlert[] = [
    {
        ...
        lat: 10.0488437,
        lng: 76.3052912,
        need: "Paramedics, ambulance",
        fullMessage:
            "Multiple-storey residential building collapsed after aftershock. Survivors heard under rubble on floors 2-3. Immediate heavy-lift equipment and trauma medics required.",
        userId: "USR-4821",
        alertType: "MEDICAL",
        message: "Injury from debris — deep wound, heavy bleeding. Need medics urgently.",
    ...
    },
    {
        ...
        source: "mesh",
        sourceDetails: "Verified GPS",
        title: "Trapped Person(s)",
        time: "8 min ago",
        location: "34.0580° N, 118.2500° W",
        lat: 34.0580,
        lng: -118.2500,
        need: "Heavy rescue team",
        fullMessage:
            "Family of four trapped in basement as floodwater rises. Water currently at waist level and rising. Children aged 3 and 7 present. Portable pumps and inflatable rescue boat needed.",
        userId: "USR-7193",
        alertType: "TRAPPED",
        message: "Family of 3 stuck in flooded basement, water rising fast. Children present — inflatable rescue boat needed.",
    ...
    },
    {
        ...
        need: "Paramedics, ambulance",
        fullMessage:
            "Strong gas odour reported near Lincoln Elementary. Suspected ruptured main line. ~200 children still inside. Evacuation corridor and HazMat containment unit requested.",
        userId: "USR-3310",
        alertType: "MEDICAL",
        message: "Child with high fever and difficulty breathing near school zone. No transport available.",
    ...
    },
    {
        ...
        lat: 34.0700,
        lng: -118.2550,
        need: "Assessment crew",
        fullMessage:
            "Large debris field blocking both lanes of Highway 101 between exits 14 and 15. No casualties reported yet. DOT crew and tow trucks requested.",
        userId: "USR-5502",
        alertType: "GENERAL",
        message: "Highway 101 blocked by debris — both lanes. DOT crew needed.",
    ...
    },
    {
        ...
        source: "mesh",
        sourceDetails: "Verified GPS",
        title: "Evacuation/Rescue",
        time: "18 min ago",
        location: "34.1184° N, 118.3004° W",
        lat: 34.1184,
        lng: -118.3004,
        need: "Evacuation vehicles",
        fullMessage:
            "Solo hiker with suspected spinal injury after a fall on the upper Griffith Trail. Conscious but unable to move. Trail too narrow for ground stretcher — helicopter extraction recommended.",
        userId: "USR-8847",
        alertType: "RESCUE",
        message: "Hiker with suspected spinal injury — helicopter extraction needed. Trail too narrow for stretcher.",
    ...
    },
    {
        ...
        source: "mesh",
        sourceDetails: "Verified GPS",
        title: "Food/Water Required",
        time: "25 min ago",
        location: "34.0407° N, 118.2468° W",
        lat: 34.0407,
        lng: -118.2468,
        need: "Food & water supply",
        fullMessage:
            "Downtown Convention Center shelter has reached max capacity of 800 occupants. Over 60 people still arriving per hour. Need secondary shelter site and additional supply shipments.",
        userId: "USR-2205",
        alertType: "FOOD",
        message: "Shelter at capacity. No food or water for 200+ evacuees. Children and elderly prioritised.",
    ...
    },
    {
        ...
        need: "Paramedics, ambulance",
        fullMessage:
            "Complete power grid failure across District 4. Two hospital annexes running on backup generators with limited fuel. Priority: mobile generator to Mercy Clinic annex.",
        userId: "USR-6439",
        alertType: "MEDICAL",
        message: "Elderly woman collapsed, unconscious, no pulse detected. Power outage affecting District 4 medical units.",
    ...
    },
    {
        ...
        need: "Evacuation vehicles",
        fullMessage:
            "Oak Manor assisted-living facility has 45 elderly residents unable to self-evacuate. Elevator non-functional due to power outage. Several residents are oxygen-dependent.",
        userId: "USR-1076",
        alertType: "RESCUE",
        message: "45 elderly residents unable to evacuate. Several oxygen-dependent. Accessible buses and nursing support needed.",
